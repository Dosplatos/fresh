...
by adding them to `styles` and `scripts` arrays in this object. The plugin can
also replace the the HTML in side the `<body>`-element of the page by including
a `htmlText` string in this object.
